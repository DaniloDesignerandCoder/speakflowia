...
export default function MusicLab() {
  ...
  function advanceWordMission(){setWordMissionIndex(index=>(index+1)%missedWords.length);setWordSpeakResult(null);}
